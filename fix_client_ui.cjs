...
content = content.replace(/from-indigo-600/g, "from-zinc-900");
content = content.replace(/to-indigo-500/g, "to-zinc-800");
content = content.replace(/shadow-indigo-600\/20/g, "shadow-zinc-900\/20");
content = content.replace(/shadow-indigo-600\/30/g, "shadow-zinc-900\/30");
