...
const targetCard = `                    <div key={s.id} className="p-6 border border-zinc-100 rounded-[24px] bg-white flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-zinc-900/5 hover:border-zinc-200 hover:-translate-y-1 transition-all relative">
                      <button 
...
const replacementCard = `                    <div key={s.id} className="p-6 border border-zinc-100 rounded-[24px] bg-white flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-zinc-900/5 hover:border-zinc-200 hover:-translate-y-1 transition-all relative">
                      <div className="flex justify-between items-start gap-4 mb-2">
                        ...
                        <button 
                          onClick={() => handleEditService(s)}
                          className="p-2 -mr-2 -mt-2 text-zinc-400 hover:text-zinc-900 hover:bg-zinc-100 rounded-full transition-colors shrink-0"
