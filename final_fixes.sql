-- 1. Fix services table (add duration_minutes and RLS policy)
ALTER TABLE public.services ADD COLUMN IF NOT EXISTS duration_minutes INT DEFAULT 30;
...
-- 2. Update the RPC function to correctly insert into the staff table
